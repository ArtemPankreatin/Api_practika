...
def Parser(request):
    ...
    if user:
        ...
        if user.role == "admin":
            ...
            if request.method == 'GET_USERS':  # done
            ...
            elif request.method == 'CREATE_USER':  # done
            ...
            elif request.method == 'DELETE_USER':  # done
                response = []
            ...
            elif request.method == 'GET_BOOKS':  # done
            ...
            elif request.method == 'CREATE_BOOKS':  # done
                response = []
                date_book = [int(i)
            ...
            elif request.method == 'DELETE_BOOK':  # done
                response = []
            ...
            elif request.method == "GET_GENRES":  # done
                response = ""
            ...
            elif request.method == "CREATE_GENRE":  # done
            ...
            elif request.method == "DELETE_GENRE":  # done
            ...
            elif request.method == "GET_AUTHORS":
                response = ""
            ...
            elif request.method == "CREATE_AUTHOR":  # done
            ...
            elif request.method == "DELETE_AUTHOR":  # done
                response = []
